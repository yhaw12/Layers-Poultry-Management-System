    ...
    <form method="POST" action="{{ route('eggs.update', $egg) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="number" name="crates" value="{{ old('crates', $egg->crates) }}"
            ...
            <div>
                ...
                <input type="number" name="sold_quantity" value="{{ old('sold_quantity', $egg->sold_quantity) }}"
            ...
            <div>
                ...
                <input type="date" name="sold_date"
                    value="{{ old('sold_date', $egg->sold_date ? $egg->sold_date->format('Y-m-d') : '') }}"
                    class="w-full border rounded p-2 dark:bg-gray-800 dark:border-gray-600 dark:text-white">
                @error('sold_date')
                    <p class="text-red-600 dark:text-red-400 text-sm">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="number" name="sale_price" value="{{ old('sale_price', $egg->sale_price) }}" step="0.01"
                    class="w-full border rounded p-2 dark:bg-gray-800 dark:border-gray-600 dark:text-white">
                @error('sale_price')
                    <p class="text-red-600 dark:text-red-400 text-sm">{{ $message }}</p>
                @enderror
