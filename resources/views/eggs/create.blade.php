       ...
       <form method="POST" action="{{ route('eggs.store') }}"
           ...
           <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               <div>
                   ...
                   <input type="number" name="small_eggs" value="{{ old('small_eggs') }}"
                       class="w-full border rounded p-2 dark:bg-gray-800 dark:border-gray-600 dark:text-white" required>
                   @error('small_eggs')
                       <p class="text-red-600 dark:text-red-400 text-sm">{{ $message }}</p>
                   @enderror
               ...
               <div>
                   ...
                   <input type="number" name="medium_eggs" value="{{ old('medium_eggs') }}"
                       class="w-full border rounded p-2 dark:bg-gray-800 dark:border-gray-600 dark:text-white" required>
                   @error('medium_eggs')
                       <p class="text-red-600 dark:text-red-400 text-sm">{{ $message }}</p>
                   @enderror
               ...
               <div>
                   ...
                   <input type="number" name="large_eggs" value="{{ old('large_eggs') }}"
                       class="w-full border rounded p-2 dark:bg-gray-800 dark:border-gray-600 dark:text-white" required>
                   @error('large_eggs')
                       <p class="text-red-600 dark:text-red-400 text-sm">{{ $message }}</p>
                   @enderror
               ...
               <div>
                   ...
                   <input type="number" name="cracked_eggs" value="{{ old('cracked_eggs') }}"
                       class="w-full border rounded p-2 dark:bg-gray-800 dark:border-gray-600 dark:text-white" required>
                   @error('cracked_eggs')
                       <p class="text-red-600 dark:text-red-400 text-sm">{{ $message }}</p>
                   @enderror
               ...
               <div>
                   ...
                   <select name="collected_by" class="w-full border rounded p-2 dark:bg-gray-800 dark:border-gray-600 dark:text-white" required>
                       ...
                       @foreach ($users as $user)
                           <option value="{{ $user->id }}" {{ old('collected_by') == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                       @endforeach
                   </select>
                   @error('collected_by')
                       <p class="text-red-600 dark:text-red-400 text-sm">{{ $message }}</p>
