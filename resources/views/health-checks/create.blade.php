            ...
            <div class="bg-white dark:bg-[#1a1a3a] p-6 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700 max-w-md mx-auto">
                <form method="POST" action="{{ route('health-checks.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input name="status" type="text" id="status" value="{{ old('status') }}"
                               class="w-full p-2 border rounded dark:bg-gray-800 dark:border-gray-600 dark:text-white @error('status') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <textarea name="symptoms" id="symptoms" class="w-full p-2 border rounded dark:bg-gray-800 dark:border-gray-600 dark:text-white @error('symptoms') border-red-500 @enderror"
                                  aria-describedby="symptoms-error">{{ old('symptoms') }}</textarea>
                        @error('symptoms')
                    ...
                    <div>
                        ...
                        <textarea name="treatment" id="treatment" class="w-full p-2 border rounded dark:bg-gray-800 dark:border-gray-600 dark:text-white @error('treatment') border-red-500 @enderror"
                                  aria-describedby="treatment-error">{{ old('treatment') }}</textarea>
                        @error('treatment')
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" class="w-full p-2 border rounded dark:bg-gray-800 dark:border-gray-600 dark:text-white @error('notes') border-red-500 @enderror"
                                  aria-describedby="notes-error">{{ old('notes') }}</textarea>
                        @error('notes')
