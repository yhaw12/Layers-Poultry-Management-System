...
<body class="bg-gray-100 text-gray-900 dark:bg-[#0a0a23] dark:text-white font-sans">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="relative">
                                    <button id="notification-bell" class="p-2 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500" aria-label="View notifications">
                                        ...
                                        <span id="notification-count" class="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center">0</span> <!-- Always show, even if 0 -->
                                    </button>
    ...
    constructor() {
        ...
        this.baseUrl = window.location.origin; // Ensure correct base URL
    }
    ...
    show(id, message, type = 'info', timeout = 5000) {
        ...
        // Auto-dismiss after timeout (except for critical)
    ...
    async fetchNotifications() {
        try {
            ...
            this.notificationList.innerHTML = '<p class="p-3 text-sm text-red-600 dark:text-red-400">Failed to load notifications.</p>';
        } finally {
            globalLoader.hide();
        }
    }
    ...
    async markAsRead(id) {
        try {
            ...
            this.notificationList.innerHTML = '<p class="p-3 text-sm text-red-600 dark:text-red-400">Failed to mark as read.</p>';
        }
    }
    ...
    async dismissAll() {
        try {
            ...
            this.notificationList.innerHTML = '<p class="p-3 text-sm text-red-600 dark:text-red-400">Failed to dismiss notifications.</p>';
        }
    }
